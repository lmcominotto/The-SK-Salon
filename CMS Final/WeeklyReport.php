...
if(isset($_SESSION['id'])) {
	...
	$unix_timestamp = strtotime("monday this week midnight");
	$week = date('Y-m-d H:i:s', $unix_timestamp);
	$now = date('Y-m-d H:i:s');

	$sql = "SELECT * FROM transactions WHERE transTime between '$week' and '$now' ORDER by transTime DESC";
