...
if(isset($_SESSION['id'])) {
	...
	$unix_timestamp = strtotime("today midnight");
	$today = date("Y-m-d H:i:s", $unix_timestamp);
	$now = date('Y-m-d H:i:s');

	$sql = "SELECT * FROM transactions WHERE transTime between '$today' and '$now' ORDER by transTime DESC";
