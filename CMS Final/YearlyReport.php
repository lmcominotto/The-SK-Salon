...
if(isset($_SESSION['id'])) {
	...
	$unix_timestamp = strtotime("first day of January midnight");
	$year = date('Y-m-d H:i:s', $unix_timestamp);
	$now = date('Y-m-d H:i:s');

	$sql = "SELECT * FROM transactions WHERE transTime between '$year' and '$now' ORDER by transTime DESC";
