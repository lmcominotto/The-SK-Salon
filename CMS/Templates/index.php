<?php include 'Include/header.php'; ?>
					...
					<div id="myCarousel" class="carousel" data-ride="carousel">
						...
						<div class="carousel-inner" role="listbox">
							<div class="item active">
								<img src="img/carousel1.jpeg" alt="woman">
							</div>

							<div class="item">
								<img src="img/carousel2.jpg" alt="woman 2">
							</div>

							<div class="item">
								<img src="img/carousel3.jpg" alt="woman 3">
							</div>
						</div>
				...
				<div class = "boxes">
					<div id = "contact">
						<img src = "img/hairdryer.png" width = "100" height = "100" alt = "Hairdryer"/><br/><br/>
						CONTACT<br/>
						<div class = "boxStyle">
							256.651.0571 <br/>
					...
					<div id = "location">
						<img src = "img/woman-with-long-hair.png" width = "100" height = "100" alt = "Woman with long hair"/><br/><br/>
						LOCATION<br/>
						<div class = "boxStyle">
							The SK Salon<br/>
					...
					<div id = "hours">
						<img src = "img/scissors.png" width = "100" height = "100" alt = "Scissors and Comb"/><br/><br/>
						HOURS<br/>
						<div class = "boxStyle">
							Tuesday: 9am-5pm <br/>
